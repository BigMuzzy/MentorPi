...
MentorPi A1 ROS机器人是一款基于树莓派5和ROS2驱动的智能机器人小车。它配备了闭环编码器电机、激光雷达传感器、3D深度相机和高功率舵机，具备高性能设计。掌握SLAM建图、路径规划和自动驾驶等先进功能，通过YOLOv5训练识别路标和交通信号灯。

通过多模态AI大语言模型的增强，幻尔科技MentorPi机器人小车已为下一代具身AI做好准备。我们提供教程和视频，帮助您自信地启动AI项目。
...
## 版本信息
- **当前版本**: MentorPi A1 v1.0.0
- **支持平台**: 树莓派5

---

**注**: 所有程序已预装在MentorPi A1机器人系统中，可直接运行。详细使用教程请参考[官方文档](https://docs.hiwonder.com/projects/MentorPi/en/latest/)。